        ...
        '<div class="stbody">'+
          ...
          '<div class="box-icons">'+
            '<div class="icons-ld">'+
              ...
              '</div>'+
              '<div class="share">'+
                '<button data-id="'+threadobj.id.toString()+'" data-title="'+threadobj.title+'" class="fb-share facebook shadow" aonclick="return fbs_click(\'/thread/'+threadobj.id.toString()+'/\', \''+threadobj.title+'\')" target="_blank"></button>'+
